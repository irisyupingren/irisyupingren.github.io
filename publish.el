...
(defun duncan/head-common-list (plist)
  ...
  (let ((description "The website of Iris Yuping Ren"))
    (list
...
(defun duncan/org-html-publish-to-html (plist filename pub-dir)
  ...
  (plist-put plist :html-htmlized-css-url ("/css/site.css" pub-dir t))
...
(defun duncan-publish-all ()
  ...
  (let ((make-backup-files nil)
        ...
        (user-full-name "Iris Yuping Ren")
        (user-mail-address "yuping.ren.iris@gmail.com")
        ...
        (org-entities-user
         (quote
          (("faArchive" "\\faArchive" nil "<i aria-hidden='true' class='fa fa-archive'></i>" "" "" "")
           ...
           ("faBook" "\\faBook" nil "<i aria-hidden='true' class='fa fa-book'></i>" "" "" "")
           ("faNewspaper" "\\faNewspaper" nil "<i aria-hidden='true' class='fa fa-newspaper'></i>" "" "" "")
